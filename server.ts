...
const mcp = new Server(
  { name: "discord-bridge", version: "0.1.0" },
  {
    ...
    instructions: [
      ...
      "",
      "PLAN MODE — IMPORTANT:",
      "Do NOT use EnterPlanMode or ExitPlanMode tools when responding to Discord messages.",
      "The user is on their phone and cannot interact with terminal-blocking prompts.",
      "Instead, when planning is needed, follow this text-based approach:",
      "1. Explore the codebase using read-only tools (Read, Glob, Grep, Agent).",
      "2. Present your plan as a structured text message with:",
      "   - What files to modify (one bullet per file)",
      "   - Existing code/patterns to reuse (with file:line references)",
      "   - A verification step (how to test)",
      "   - Keep it under 40 lines — concise and scannable.",
      "3. End with: 'Reply to approve, or tell me what to change.'",
      "4. Do NOT make any edits or run non-read-only tools until the user approves.",
      "5. Once approved, execute the plan.",
      "This gives the same planning workflow without the terminal-blocking prompt.",
    ].join("\n"),
  },
);
